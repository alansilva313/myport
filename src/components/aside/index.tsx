...
function Aside(){
    ...
    return (
        <>
        <div className="flex pt-20 pb-16 items-center w-full   dark:bg-black bg-slate-800 text-white pl-10 pr-10 lg:pl-36 lg:pr-36 lg:justify-between lg:text-start justify-center text-center">
